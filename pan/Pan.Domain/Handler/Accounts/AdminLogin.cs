...
namespace Pan.Domain.Handler.Accounts
{
	...
	//{
	//	private readonly IRepository<post, int> _adminRepository;
	//	private readonly AccountService _accountService;

	//	public AdminLoginHandler(IRepository<post, int> adminRepository, AccountService accountService)
	//	{
	...
	//	{
	//		var admin = await _adminRepository.GetQuery().FirstOrDefaultAsync(x => x. Title == request.Account);
